...
public class PlayerMovement : MonoBehaviour
{
    ...
    [SerializeField] Sound stepSound; //Variable de sonido del paso.
    #endregion
    ...
    private void Update()
    {
        ...
        moveRotation = Input.GetAxisRaw("Horizontal") * rotationSpeed; //Guardamos el axis horizontal.
    }
    ...
    private void FixedUpdate()
    {
        if (moveForward != 0 || moveRotation != 0) //Si alguno de los dos es diferente de 0 nos movemos.
        {
            ...
            isWalking = moveForward !=0 ? true : false; //Seteamos que nos estamos moviendo.
            if (isWalking) { GameManager.instance.PlayAudio(stepSound); }
        }
        else
        {
            isWalking = false;
